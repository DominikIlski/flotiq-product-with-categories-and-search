    ...
    <div className="container details-page">
      <div className="product-details">
        <div className="Product-Screenshot">
          {data.data.product.productGallery &&
          data.data.product.productGallery.length ? (
            <Tabs>
        ...
        <div>
          <h2>
            <a href={`/${data.data.product.category[0].slug}`}>
              {data.data.product.category[0].name}
            </a>{" "}
        ...
        <div>
            ...
            Weight Option: {data.data.product.option}
            </span>
          </div>
          ...
          <div className="col-sm-10 text-left">
            <a
              ...
              data-item-image={
                ...
                data.data.product.productImage[0]
                  ? `${process.env.GATSBY_FLOTIQ_BASE_URL}/image/1920x0/${data.data.product.productImage[0].id}.${data.data.product.productImage[0].extension}`
                  : ""
              }
              data-item-name={data.data.product.name}
              data-item-url={`/`}
            >
