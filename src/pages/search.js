...
const IndexSearch = () => {
  ...
  useEffect(() => {
    async () => {
        const allCategories = await fetch(`${process.env.GATSBY_FLOTIQ_BASE_URL}/api/v1/content/category?order_by=name`, {
          headers: {'x-auth-token': '26f841d43814d82c01c885b899fb475b'}
        }).then((res) => res.json());
